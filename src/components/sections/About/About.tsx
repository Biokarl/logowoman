...
const features = [
  ...
  },
  {
    ...
    description: 'Гибкое расписание занятий, подстраиваемся под вашу занятость'
  },
  {
    icon: (
      <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
    ...
    <section className={`section ${styles.about}`} id="about">
      <div className="container">
        ...
        >
          ...
          <p>
            Мы создали пространство, где каждый ребёнок получает внимание, 
            заботу и профессиональную помощь
          </p>
        </motion.div>
